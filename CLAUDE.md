...
1. This file (CLAUDE.md) for repo-wide rules.
2. `docs/PLAN.md` for the current phase's scope and out-of-scope items.
3. `docs/ARCHITECTURE.md` (when written) for cross-cutting decisions.
4. The relevant book chapter or chapters for the current phase, which the human will provide in the session.
