...
system's own hosts by scope (PLAN.md:503), and it is a teaching artifact, not a
production migration (PLAN.md:512). This ADR records the decisions the demo made that
