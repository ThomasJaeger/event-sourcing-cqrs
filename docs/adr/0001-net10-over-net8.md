...
The deviation from the manuscript is acknowledged. Phase 14 of the build plan owes a manuscript reconciliation edit that updates Part 4's framework and language references and the support-window claim accordingly.
...
In Phase 14, edit Part 4 of the manuscript to:
...
- A manuscript edit is owed in Phase 14. PLAN.md tracks this as part of the Phase 14 done-when criteria.
