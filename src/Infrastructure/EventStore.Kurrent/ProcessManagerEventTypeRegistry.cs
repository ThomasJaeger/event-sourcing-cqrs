...
// The PM twin of EventTypeRegistry, constrained to IProcessManagerEvent. PM events resolve
// through this separate registry, selected by the typed read method rather than by per-row
// inspection (ADR 0013).
//
// Duplicated from the relational adapters per ADR 0004, same as its aggregate twin, and the same
// third-copy note applies.
