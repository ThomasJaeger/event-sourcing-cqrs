...
public sealed class SqlServerMigrationChecksumMismatchException : Exception
{
    public SqlServerMigrationChecksumMismatchException(
        int version, string name, string stored, string computed)
        : base(
