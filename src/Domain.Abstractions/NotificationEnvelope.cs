...
// Carries projection name, resource identifier, causing event name, the affected
// widgets, and the tenant the projected change belongs to (sourced from the event
// metadata). That is enough for the SignalR hub to route to the correct
